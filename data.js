const manual = {
    ...
    "husband": {
        ...
        "method": "Synchronizing two distinct scripts into a single, unified execution. Identifying the 'other' as the necessary completion of the system's circuit.",
        "legacy": "A blueprint for partnership where the ego is subsumed by the logic of the Pair."
    },
    "son": {
        "root": "B-N-Y (ب ن ي)",
        "logic": "Your function is not 'being a son'; it is 'Continuing the Build.'",
        "method": "Acting as the structural extension of the previous generation. You are the fresh stone placed upon an established foundation to ensure height.",
        "legacy": "A structure that stands taller than its predecessors because it respected the base upon which it was built."
    },
    "provider": {
        "root": "R-Z-Q (ر ز ق)",
        "logic": "You are not the Source; you are the Router.",
        "method": "Directing 'packets' of sustenance efficiently to where they are required. A router does not own the data; it ensures the flow is never congested or blocked.",
    ...
    "father": {
        ...
        "method": "Establishing the protective framework and nutrient-rich environment for a seed to manifest its inherent potential. You are the gardener of the Script.",
        "legacy": "A robust lineage that grew tall because it was rooted in a consistent, stable environment."
    },
    "mother": {
        "root": "U-M-M (أ م م)",
        "logic": "The function of 'Founding.'",
        "method": "Acting as the primary source of origin (Umm). You are the 'Home Base' and the prototype from which all subsequent logic and safety is derived.",
        "legacy": "An unbreakable foundation of security that allowed others to explore the world without losing orientation."
    },
    "brother": {
        "root": "A-Kh-W (أ خ و)",
        "logic": "The function of 'Bracing.'",
    ...
    "neighbor": {
        ...
        "method": "Extending the boundaries of your own security to cover those physically adjacent to you. Creating a buffer zone of peace.",
    ...
    "truth": {
        ...
        "method": "Stripping away personal bias to align the internal compass with the fixed external reality. Validating inputs against the Absolute (Al-Ḥaqq).",
        "legacy": "A life lived in high fidelity, where every action was a true reflection of the objective world."
    },
    "time": {
        "root": "ʿ-Ṣ-R (ع ص ر)",
        "logic": "The function of 'Extraction.'",
        "method": "Applying intentional pressure to the moments of life to squeeze out the essence of value. Time is the 'press' of human potential.",
        "legacy": "The pure oil of meaningful work, left behind after discarding the pulp of idle hours."
    },
    "peace": {
        "root": "S-L-M (س ل م)",
        "logic": "The function of 'Integrity.'",
        "method": "Ensuring every component of the system is sound and uncorrupted. Peace is the absence of internal friction and systemic failure.",
        "legacy": "A legacy of zero friction, where the system functioned exactly as it was designed."
    },
    "justice": {
        "root": "ʿ-D-L (ع د ل)",
        "logic": "The function of 'Equilibrium.'",
        "method": "Placing everything in its exact rightful position. It is the mathematical balance required for systemic stability.",
    ...
    "heart": {
        ...
        "method": "Constantly flipping and testing inputs to ensure the center remains aligned with the Truth. It is the filter of intent.",
        "legacy": "A calibrated center that remained pure despite external turbulence."
    },
    "intellect": {
        "root": "ʿ-Q-L (ع ق ل)",
        "logic": "The function of 'Restraint.'",
        "method": "Binding the impulses to the logic of the Script. Like a tether, it prevents the system from drifting into chaotic variables.",
        "legacy": "A life of controlled power, directed toward a specific purpose."
    },
    "wisdom": {
        "root": "Ḥ-K-M (ح ك م)",
        "logic": "The function of 'Governance.'",
        "method": "The ability to execute the right logic at the right time in the right proportion. It is the 'Operating System' of the soul.",
        "legacy": "A history of decisions that stood the test of time."
    },
    "patience": {
        "root": "Ṣ-B-R (ص ب ر)",
        "logic": "The function of 'Binding.'",
    ...
    "pen": {
        ...
        "method": "Choosing to record a specific reality through action. You are the stylus that etches the legacy into the fabric of time.",
        "legacy": "A permanent record of a life lived with intent."
    },
    "book": {
        "root": "K-T-B (ك ت ب)",
        "logic": "The function of 'Prescription.'",
        "method": "The assembly of individual actions into a coherent, unchangeable narrative. The final output of the script.",
        "legacy": "A completed manual that others can read to understand the logic of your existence."
    },
    "speech": {
        "root": "Q-W-L (ق و ل)",
        "logic": "The function of 'Vibration.'",
    ...
    "success": {
        ...
        "method": "Breaking through the hard soil of resistance to allow the seed of intent to emerge. Success is the labor of the breakthrough.",
        "legacy": "A harvest that sustains generations because you were willing to break the ground."
    },
    "gratitude": {
        "root": "Sh-K-R (ش ك ر)",
        "logic": "The function of 'Expansion.'",
        "method": "Recognizing the value of an input, which signals the system to allocate more resources to that specific path.",
        "legacy": "A life of abundance created by the continuous recognition of value."
    },
    "mercy": {
        "root": "R-Ḥ-M (ر ح م)",
